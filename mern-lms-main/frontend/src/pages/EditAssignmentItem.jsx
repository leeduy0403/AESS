...
export default function EditAssignmentItem() {
  ...
  useEffect(() => {
    ...
    const fetchMaterials = async () => {
      ...
      try {
        ...
        const resMaterial = await fetch(
          `/api/material/get-materials-assignment/${assignmentId}?materialId=${materialId}`
        );
    ...
    fetchMaterials();
  }, [location.search, assignmentId, classId, materialId]);
