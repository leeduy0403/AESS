...
export default function AddSectionItem() {
  ...
  useEffect(() => {
    ...
    fetchMaterials();
  }, [location.search, sectionId, classId]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `/api/material/create-material-section/${sectionId}`,
        {
          method: "POST",
          headers: {
      ...
      if (data.success === false) {
        ...
        setCreateSuccess("Add section item successfully!");
