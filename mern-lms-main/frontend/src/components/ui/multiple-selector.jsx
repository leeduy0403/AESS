  ...
  return (
    ...
    >
      ...
      >
        <div className="relative flex flex-wrap gap-1">
          ...
          <CommandPrimitive.Input
            ...
            className={cn(
              "flex-1 bg-transparent border-none outline-none focus:border-transparent focus:ring-0 placeholder:text-muted-foreground",
              {
      ...
      <div className="relative">
        {open && (
          <CommandList
            className="absolute top-1 z-10 w-full rounded-md border bg-white text-popover-foreground shadow-md outline-none animate-in"
            onMouseLeave={() => {
