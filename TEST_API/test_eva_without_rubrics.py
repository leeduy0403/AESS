...
def extract_scores_and_feedback(response_text):
    ...
    feedback = clean_feedback(feedback)  # Apply cleanup function

    # Compute overall score based on the sum of component scores
    ovr = min(6, max(1, coherence + lexical + grammar))  # Ensure it stays in [1,6]
